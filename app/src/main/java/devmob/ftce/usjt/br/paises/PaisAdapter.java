...
import static devmob.ftce.usjt.br.paises.R.drawable.bandeira;
...
public class PaisAdapter  extends BaseAdapter implements SectionIndexer {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.getDetalhe().setText(String.format("região: %s - capital: %s", paises[position].getRegiao(), paises[position].getCapital()));
